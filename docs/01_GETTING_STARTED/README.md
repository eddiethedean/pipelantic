...
1. [Current 0.12 guide](CURRENT_VERSION.md) — task-based map
2. [Installation](INSTALLATION.md) — `pip install etlantic==0.12.0`
...
ETLantic 0.12.0 can execute registered Python implementations with its local
