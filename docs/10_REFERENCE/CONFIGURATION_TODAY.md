# Configuration in 0.16.0

ETLantic 0.16.0 configures execution with a `Profile` object or a JSON profile
...
ETLantic 0.16.0 does not auto-read `ETLANTIC_PROFILE`, `ETLANTIC_CONFIG`,
