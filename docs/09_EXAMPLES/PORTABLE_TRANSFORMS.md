...
!!! success "**Status: Available since ETLantic 0.17** (Polars + PySpark + Pandas + SQL relational); current docs target **0.19.0**."
...
```bash
pip install 'etlantic==0.20.0' 'etlantic-polars==0.20.0'
# from a checkout:
