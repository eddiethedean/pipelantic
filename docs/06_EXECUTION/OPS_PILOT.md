...
> **Status: Available in ETLantic 0.12.0.** Alpha operational checklist—not a
...
```bash
pip install 'etlantic==0.12.0'
# Only the engines you need:
pip install 'etlantic-polars==0.12.0'   # or pandas / sql / pyspark / airflow
```
