...
Prefer pages marked **Available in 0.20** and the Green path on the docs
...
2. Treat **Available in 0.20** / **Shipped in 0.x** as current package
...
| Page status | Meaning |
|---|---|
| Available in 0.20 | Tested against the current package |
