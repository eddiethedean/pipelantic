"""Immutable PipelinePlan IR (schema pipelantic.plan/1)."""
...
from pipelantic.model import Edge, LogicalGraph, Node, NodeKind, ParameterSpec, PortSpec
from pipelantic.plan.artifacts import ArtifactRef
